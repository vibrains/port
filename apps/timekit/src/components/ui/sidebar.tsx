...
>(
  (
    ...
    // This is the internal state of the sidebar in SSR/server mode
    ...
    // This makes it easier to style the sidebar with Tailwind CSS.
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Generate a pseudo-random width between 50 to 90% based on component instance
